  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
        ...
        <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span>Case Study <i class="fa fa-chevron-right"></i></span></p>
      </div>
    </div>
  </div>
</section>
 ...
 <div class="container">
  ...
  <div class="row">
    ...
    <div class="text text-center">
      ...
      <h3><a href="project.html">Building High-Performance Business Tools</a></h3>
    </div>
...
<div class="col-md-6 col-lg-3 ftco-animate">
  ...
  <div class="text text-center">
    ...
    <h3><a href="project.html">Your Proactive 24/7 Technology Partner</a></h3>
  </div>
...
<div class="col-md-6 col-lg-3 ftco-animate">
  ...
  <div class="text text-center">
    ...
    <h3><a href="project.html">Scalable Solutions for Modern Business</a></h3>
  </div>
...
<div class="col-md-6 col-lg-3 ftco-animate">
  ...
  <div class="text text-center">
    ...
    <h3><a href="project.html"> Proactive Threat & Vulnerability Analysis</a></h3>
  </div>
